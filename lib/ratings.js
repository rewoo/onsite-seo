...
ratings.getPageSocial = function(page) {

  var ograph = page.meta.ograph || {},
      twitter = page.meta.twitter || {},
      microsoft = page.meta.microsoft || {};
  var result = [
    {title: 'Facebook: App Id', value: ograph.app || '', class: 'facebook'},
    {title: 'Facebook: Title', value: ograph.title || '', class: 'facebook'},
    {title: 'Facebook: Type', value: ograph.type || '', class: 'facebook'},
    {title: 'Facebook: URL', value: ograph.url || '', class: 'facebook'},
    {title: 'Facebook: Image', value: ograph.image || '', class: 'facebook'},
    {title: 'Facebook: Description', value: ograph.description || '', class: 'facebook'},
    {title: 'Twitter: Type', value: twitter.card || '', class: 'twitter'},
    {title: 'Twitter: Site', value: twitter.site || '', class: 'twitter'},
    {title: 'Twitter: Creator', value: twitter.creator || '', class: 'twitter'},
    {title: 'Twitter: Title', value: twitter.title || '', class: 'twitter'},
    {title: 'Twitter: Description', value: twitter.description || '', class: 'twitter'},
    {title: 'Twitter: Image', value: twitter.image || '', class: 'twitter'},
    {title: 'Microsoft: App Name', value: microsoft.application || '', class: 'microsoft'},
    {title: 'Microsoft: Tile Color', value: microsoft.msTileColor || '', class: 'microsoft'},
    {title: 'Microsoft: Tile Image', value: microsoft.msTileImage || '', class: 'microsoft'},
    {title: 'Microsoft: Square 70 Logo', value: microsoft.msSquare70 || '', class: 'microsoft'},
    {title: 'Microsoft: Square 150 Logo', value: microsoft.msSquare150 || '', class: 'microsoft'},
    {title: 'Microsoft: Square 310 Logo', value: microsoft.msSquare310 || '', class: 'microsoft'},
    {title: 'Microsoft: Wide 310x150 Logo', value: microsoft.msWide310 || '', class: 'microsoft'}
  ];
  return result;
}
